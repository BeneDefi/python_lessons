...
for student in students:
     ...
     record = {student_id: (student_name, student_score)}
...
print(f"All High Performers: {high_performers}")
print(f"All Average Performers: {average_performers}")
print(f"All Low Performers: {low_performers}\n")
